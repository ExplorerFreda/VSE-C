...
class PrecompTrainCaptionExtendedDataset(data.Dataset):
    """
    Load precomputed captions and image features
    Possible options: f8k, f30k, coco, 10crop
    """

    def __init__(self, data_path, data_split, vocab, cap_suffix='caps', num_negative=5):
        self.vocab = vocab
        loc = data_path + '/'
        ...
        self.extended_path = loc + data_split + '_ex/'
...
class PrecompTestCaptionExtendedDataset(data.Dataset):
    def __init__(self, data_path, data_split, vocab, cap_suffix='caps'):
        self.vocab = vocab
        loc = data_path + '/'
